...
|---|---|---|
| **App icon** (custom, not Flutter default) | ⚠️ Design source ingested — Master PNG at `design/app-icon/source/ai-food-passport-selected-icon-master.png` (1254x1254 px, 2.24 MB). NOT yet applied to Flutter/iOS. See `APP_ICON_MASTER_ASSET_INTAKE.md` (Phase 22B). | High (before TestFlight) |
